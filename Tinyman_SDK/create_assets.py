...
def create_Asset():
    try:
        ...
        ASSET_A_ID = create_asset(algod, account["address"], account["private_key"] , Asset_Name="Asset 1")
        ASSET_B_ID = create_asset(algod, account["address"], account["private_key"] , Asset_Name="Asset 2")
        ...
        return {"Generated Assets" : [ASSET_A_ID , ASSET_B_ID]}
